...
from app.cardmarket import enqueue_job, is_job_url, prices_for_row, snapshot_prices, url_for_row
    ...
    *,
    ...
    if combined:
        ...
        if top_row is not None:
            ...
            if is_job_url(live_url) and not snapshot_prices(catalog, live_url):
